    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
        <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-lg">
          <img
            src="/logo.png"
            className="mx-auto mb-6 h-24 w-24 drop-shadow-xl"
          ...
          <button
            type="button"
            onClick={handleLogin}
            className="w-full rounded-lg bg-gradient-to-r from-teal-600 to-cyan-500 px-4 py-2 font-medium text-white shadow-sm hover:from-teal-700 hover:to-cyan-600"
          >
            Login
          </button>
        </div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="rounded-lg bg-gradient-to-r from-teal-600 to-cyan-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:from-teal-700 hover:to-cyan-600 disabled:opacity-50"
          >
            Export CSV
          </button>
        </div>
